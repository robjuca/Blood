...
using Gadget.Report.Shell.Presentation;
using Gadget.Report.Shell.Pattern.Models;
//---------------------------//

namespace Gadget.Report.Shell.Pattern.ViewModels
{
  ...
  public class TShellViewModel : TShellViewModel<TShellModel>, IShellViewModel
  {
    ...
    public TShellViewModel (IShellPresentation presentation)
      : base (presentation, new TShellModel (), TProcess.GADGETREPORT)
    {
    }
    #endregion
