...
namespace Gadget.Factory.Pattern.Models
{
  public class TFactoryPropertyModel : NotificationObject
  {
    ...
    {
      ComponentModelProperty = TModelProperty.Create (Server.Models.Infrastructure.TCategory.Report);
    ...
    internal void SelectModel (TEntityAction action)
    {
      ...
      //var tag = action.ModelAction.GadgetReportModel.MaterialId;
    ...
    internal void RequestModel (TEntityAction action)
    {
      if (action.NotNull ()) {
        ...
        if (action.SupportAction.SelectionInfo.Tag is Guid materialId) {
          ...
          action.ModelAction.ExtensionNodeModel.ChildCategory = Server.Models.Infrastructure.TCategoryType.ToValue (Server.Models.Infrastructure.TCategory.Report);
        ...
        // update model
        //action.ModelAction.GadgetReportModel.CopyFrom (action);
      }
    }
