...
using Gadget.Tests.Shell.Presentation;
using Gadget.Tests.Shell.Pattern.Models;
//---------------------------//

namespace Gadget.Tests.Shell.Pattern.ViewModels
{
  ...
  public class TShellViewModel : TShellViewModel<TShellModel>, IShellViewModel
  {
    ...
    public TShellViewModel (IShellPresentation presentation)
      : base (new TShellModel (), TProcess.GADGETTESTS)
    {
