...
namespace Gadget.Factory.Pattern.ViewModels
{
  ...
  public class TFactoryPropertyViewModel : TViewModelAware<TFactoryPropertyModel>, IHandleMessageInternal, IFactoryPropertyViewModel
  {
    ...
    public void OnApplyCommadClicked ()
    {
      ...
      // Insert
      var action = Server.Models.Component.TEntityAction.Create (Server.Models.Infrastructure.TCategory.Tests, Server.Models.Infrastructure.TOperation.Insert);

      if (IsViewModeEdit) {
        // Change-Full
        action = Server.Models.Component.TEntityAction.Create (Server.Models.Infrastructure.TCategory.Tests, Server.Models.Infrastructure.TOperation.Change, Server.Models.Infrastructure.TExtension.Full);
      }
